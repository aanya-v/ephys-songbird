function [q_maxs_acoustic_groupings, H_maxs_acoustic_groupings ] = poisson_analysis(case_id)
...
n_random = 30;
q_maxs_acoustic_groupings = zeros(n_random,4);
H_maxs_acoustic_groupings = zeros(n_random,4);
...
for count = 1:n_random
    ...
    for_3dacoustics = 3;
        ...
        if(length(significance_of_H_3dacoustics)>1 && sum(significance_of_H_3dacoustics(1:11)>=1))
         ...
         q_maxs_acoustic_groupings(count,:) = [q_max_3dacoustics q_max_pitch q_max_amplitude q_max_spectral_entropy]
         H_maxs_acoustic_groupings(count,:) = [H_max_3dacoustics H_max_pitch H_max_amplitude H_max_spectral_entropy]
